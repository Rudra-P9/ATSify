...
- Knowledge of statistical modeling and A/B testing.`
    },
    {
        ...
        title: 'UX Designer',
        text: `UX Designer
Role: Define user interaction models and interface specifications.

Responsibilities:
- Conduct user research and usability testing.
- Create wireframes, storyboards, and site maps.
...
- Research-driven mindset and attention to detail.`
    },
    {
        id: 'sdr',
        title: 'Sales Development Representative',
        text: `Sales Development Representative (SDR)
Focus: CRM & Lead Generation

Responsibilities:
- Identify and qualify new sales opportunities.
- Manage leads through CRM (Salesforce/HubSpot).
- Outbound prospecting via email and phone.
- Work closely with Account Executives.

Requirements:
- 1+ year of experience in sales or business development.
- Excellent communication and persistence.
- Experience with CRM tools and lead generation techniques.`
    }
];
